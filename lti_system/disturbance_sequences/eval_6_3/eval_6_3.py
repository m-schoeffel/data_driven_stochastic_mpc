...
name_sequence = "eval_6_3"

x_1 = np.random.normal(loc=0, scale=0.0005,size=500)
x_2 = np.random.normal(loc=0, scale=0.0005,size=500)
x_3 = np.random.normal(loc=0, scale=0.0005,size=500)
x_4 = np.random.normal(loc=0, scale=0.0005,size=500)
