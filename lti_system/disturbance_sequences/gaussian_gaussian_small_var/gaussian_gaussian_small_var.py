...
# The distribution for the first 250 samples is a gaussian distribution with mean -0.15 and standard deviation 0.02
# The distribution for the last 250 samples is a gaussian distribution with mean 0.1 and standard deviation 0.04

name_sequence = "gaussian_gaussian_small_var"

x_1_first_250 = np.random.normal(loc=-0.15, scale=0.02,size=250)
x_1_last_250 = np.random.normal(loc=0.1, scale=0.04,size=250)
