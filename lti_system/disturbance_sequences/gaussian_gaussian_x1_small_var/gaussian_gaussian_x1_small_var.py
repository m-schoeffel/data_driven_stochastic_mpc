...
# There is no disturbance on the states 2-4
...
name_sequence = "gaussian_gaussian_x1_small_var"

x_1_first_250 = np.random.normal(loc=-0.15, scale=0.01,size=250)
x_1_last_250 = np.random.normal(loc=0.1, scale=0.01,size=250)
